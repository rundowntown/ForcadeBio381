...
% TITLE PAGE DATA--------------------------
\title[]{The Rundown} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{yukontrail.jpg}}
\begin{frame}
